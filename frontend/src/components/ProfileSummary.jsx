...
const ProfileSummary = ({ humanDescription }) => {
  ...
  const { name, age, lifeStage, netWorth, totalLiability, creditScore, employment } = humanDescription;
  return (
    <div className="profile-analysis" style={{ backgroundColor: "#0b0f10" }}>
      <div className="preview-section">
        <div className="preview-grid preview-item">
          ...
          <div className=" preview-item ">
            <span className="preview-value text-5xl text-center items-center flex justify-center">{age}</span>
          </div>

          <div className="preview-item">
            <span className="preview-label">Net Worth</span>
            <span className="preview-value">₹{parseInt(netWorth).toLocaleString()}</span>
          </div>
          <div className="preview-item">
            <span className="preview-label">Total Liability</span>
            <span className="preview-value">₹{parseInt(totalLiability).toLocaleString()}</span>
          </div>
          <div className="preview-item twoXL">
          ...
          <div className="preview-item">
            ...
            <span className="preview-value">{employment?.currentEmployer}</span>
          </div>
          <div className="preview-item">
            <span className="preview-label">Work Experience (years)</span>
            <span className="preview-value">{employment?.workExperienceYears}</span>
          </div>
          <div className="preview-item">
            <span className="preview-label">Career Trajectory</span>
            <span className="preview-value">{employment?.careerTrajectory}</span>
          </div>
        </div>
      </div>
    </div>
